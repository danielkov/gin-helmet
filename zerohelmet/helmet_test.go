...
// testMiddleware creates a handler with the given middleware and makes a test request
func testMiddleware(t *testing.T, middleware rest.Middleware) *http.Response {
...
func TestDefault(t *testing.T) {
	...
	// Create a handler with all default middlewares
...
func TestZeroHeaderWriter_SetHeader(t *testing.T) {
...
func TestZeroHeaderWriter_Next(t *testing.T) {
	w := httptest.NewRecorder()
	writer := &ZeroHeaderWriter{writer: w}
