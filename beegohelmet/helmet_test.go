...
func setupTestServer(middleware BeegoMiddleware) *httptest.Server {
	...
	return httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		// Create Beego context from HTTP request
...
func TestCrossOriginResourcePolicyCustom(t *testing.T) {
	server := setupTestServer(CrossOriginResourcePolicy("cross-origin"))
	defer server.Close()
...
func TestDefault(t *testing.T) {
	...
	// Create a test server that applies all default middlewares
...
func TestBeegoHeaderWriter_SetHeader(t *testing.T) {
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := context.NewContext()
		ctx.Reset(w, r)
...
func TestBeegoHeaderWriter_Next(t *testing.T) {
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := context.NewContext()
		ctx.Reset(w, r)
